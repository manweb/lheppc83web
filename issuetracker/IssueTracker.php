<p align="right" style="margin-top: 5; margin-bottom: 5; margin-right: 20;"><a href="index.php?page=issuetracker/NewIssue.php" title="Submit new issue"><img src="../image/add_issue.png"></a><a href="index.php?page=issuetracker/issue_solved.php" title="Mark issue solved"><img src="../image/issue_solved.png"></a><a href="index.php?page=issuetracker/archive_issue.php" title="Archive issue"><img src="../image/archive_issue.png"></a><a href="index.php?page=issuetracker/delete_issue.php" title="Delete issue"><img src="../image/delete_issue.png"></a></p>
