...
while ($issues = mysql_fetch_assoc($result)) {
  ...
  echo "<table align='right' border='0' bordercolor='#000000' cellpadding='0' cellspacing='0' style='border-collapse: collapse; ' width='670'>\n";
  echo "<tr>\n";
  echo "<td valign='top' align='left' style='border-color: #0000FF; border-left-style: dashed; border-left-width: 1; border-right-style: dashed; border-right-width: 1; border-top-style: dashed; border-top-width: 1; border-bottom-style: dashed; border-bottom-width: 1; paddingtop: 5; padding-left: 5; padding-right: 5; padding-right: 5;' width='650' bgcolor='#E2E2E2'><font size='2'><br>".nl2br($issues['Message'])."</font>\n";
  echo "<br>\n";
  echo "</td>\n";
